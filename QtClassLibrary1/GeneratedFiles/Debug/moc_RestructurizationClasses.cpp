/****************************************************************************
** Meta object code from reading C++ file 'RestructurizationClasses.h'
**
...
#error "The header file 'RestructurizationClasses.h' doesn't include <QObject>."
...
void MyModuleForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyModuleForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MyModuleForm::staticMetaObject = { {
    QMetaObject::SuperData::link<WorkWidget::staticMetaObject>(),
    qt_meta_stringdata_MyModuleForm.data,
    qt_meta_data_MyModuleForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyHeader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MyHeader::staticMetaObject = { {
    QMetaObject::SuperData::link<QHeaderView::staticMetaObject>(),
    qt_meta_stringdata_MyHeader.data,
    qt_meta_data_MyHeader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
