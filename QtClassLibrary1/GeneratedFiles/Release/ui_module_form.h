...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        gridLayout_9->addWidget(createTablesButt, 0, 0, 1, 1);
        ...
        gridLayout_9->addWidget(deleteTablesButt, 0, 1, 1, 1);
        ...
        gridLayout_17->addWidget(fullTableView, 1, 1, 1, 1);

        verticalSpacer_21 = new QSpacerItem(20, 185, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_17->addItem(verticalSpacer_21, 2, 0, 1, 1);

        fullLable = new QLabel(scrollAreaWidgetContents_2);
        fullLable->setObjectName(QStringLiteral("fullLable"));

        gridLayout_17->addWidget(fullLable, 1, 0, 1, 1);

        verticalSpacer_20 = new QSpacerItem(20, 185, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_17->addItem(verticalSpacer_20, 0, 0, 1, 1);

        horizontalSpacer_7 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_17->addItem(horizontalSpacer_7, 1, 2, 1, 1);
        ...
        gridLayout_20->addItem(verticalSpacer_24, 2, 0, 1, 1);

        expandedLable = new QLabel(scrollAreaWidgetContents_5);
        expandedLable->setObjectName(QStringLiteral("expandedLable"));

        gridLayout_20->addWidget(expandedLable, 1, 0, 1, 1);

        verticalSpacer_25 = new QSpacerItem(20, 185, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_20->addItem(verticalSpacer_25, 0, 0, 1, 1);
        ...
        gridLayout_20->addWidget(expandedTableView, 1, 1, 1, 1);

        horizontalSpacer_8 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_20->addItem(horizontalSpacer_8, 1, 2, 1, 1);
        ...
        gridLayout_19->addItem(verticalSpacer_23, 2, 0, 1, 1);

        optiLable = new QLabel(scrollAreaWidgetContents_4);
        optiLable->setObjectName(QStringLiteral("optiLable"));

        gridLayout_19->addWidget(optiLable, 1, 0, 1, 1);

        verticalSpacer_22 = new QSpacerItem(20, 185, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_19->addItem(verticalSpacer_22, 0, 0, 1, 1);
        ...
        gridLayout_19->addWidget(optiTableView, 1, 1, 1, 1);

        horizontalSpacer_6 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_19->addItem(horizontalSpacer_6, 1, 2, 1, 1);
